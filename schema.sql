...
SELECT currency, amount, symbol FROM prices INNER JOIN currencies ON prices.currency =currencies.label WHERE product_id='huarache-x-stussy-le'  ;
...
SELECT * FROM product_gallery WHERE product_id='huarache-x-stussy-le';

SELECT * FROM product_attributes INNER JOIN attributes ON attributes.id = product_attributes.attribute_id ; 
